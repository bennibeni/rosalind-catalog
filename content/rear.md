...
## Nota
Come spiegato in una risposta precedente, questa cartella contiene anche `sets10.txt`,
un file di cache generato dallo script stesso (non un input da fornire) che precalcola,
tramite BFS, i livelli di distanza per tutte le permutazioni di 10 elementi raggiungibili
dall'identità, per evitare di ricalcolarli ad ogni esecuzione.
